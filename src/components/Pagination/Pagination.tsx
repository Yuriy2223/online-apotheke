  ...
  return (
    ...
    >
      ...
      <div className="order-1 sm:order-2">
        <ReactPaginate
          previousLabel={
            <div className="flex items-center gap-2 px-3 py-2 text-gray-600 hover:text-blue-600 transition-colors">
              <ChevronLeft size={16} />
          ...
          pageLinkClassName="flex items-center justify-center min-w-[40px] h-10 px-3 text-sm text-gray-700 hover:bg-gray-50 hover:text-blue-600 transition-colors border-r border-gray-200 last:border-r-0"
