...
export default function TelegramHelpWidget() {
  return (
    ...
    >
      ...
      rounded-xl px-4 py-3 flex flex-col gap-1 max-w-xs group-hover:shadow-xl transition"
      >
      ...
      <div
        className="w-14 h-14 rounded-full bg-[#229ED9] text-white
       grid place-items-center shadow-lg group-hover:scale-105 group-hover:shadow-xl transition"
      >
        <svg
          viewBox="0 0 24 24"
          className="w-6 h-6"
