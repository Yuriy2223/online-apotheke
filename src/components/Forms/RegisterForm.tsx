  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full max-w-[300px] bg-green-light text-white-true py-2 px-4 rounded-lg hover:bg-green-dark disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-medium"
      >
